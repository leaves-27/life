...
## 概述
古典热力学由于忽视能量的流动，所以得出的结论是系统从一个状态过渡到另一个状态，是没有时间方向的。但那只在封闭系统有效。在开放的系统中，我们会发现能量的流动，系统是不可逆的，是有方向的。而开放系统比封闭系统存在着更多变化，更有趣，所以值得人们的研究。
...
# 总结
图灵由于想要发明一台类似人的机器，从而发现了用算法对一些复杂情况进行描述。
图灵提出了在开放的系统中混合均匀的化学物质会自发的由内部自我催化的化学反应导致新形成的各种生成物在扩散时形成稳定图像的这一想法。而贝洛索夫发现了在真实的化学系统中确实存在这一想法的化学试验。
